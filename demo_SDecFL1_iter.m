...
for data_type = [1, 2]
    ...
    for q = [5, 10, 15]
        ...
        for jj = 1:ntest
            ...
            OPTIONS_iRVM.maxiter = 5000;  OPTIONS_iRVM.tol = 1e-6;
            ...
            iRVM = SDecFL1_iRVM(X0,Lf,gamma,mu_max,beta,lambda,OPTIONS_iRVM,m,n,q,A,A1,A2,Imat2q);
            ...
            RADMM = SDecFL1_RADMM(X0,eta_RADMM,sigma_RADMM,gamma_RADMM,lambda,OPTIONS_RADMM,m,n,q,A,A1,A2,Imat2q);
          ...
          %% ********************* RiALM_RGD *************************************
            ...
            OPTIONS_RiALM.maxiter = 100;  OPTIONS_RiALM.tol = 1e-4;
        
            OPTIONS_RiALM.printyes = 0;   OPTIONS_RiALM.normA = normA;
        
            sigma_RALM = 1.5;  b = 1.5;  err = 1e-3;
        
            rng(state);
        
            tstart = clock;
        
            RiALM = SDecFL1_RiALM(X0,sigma_RALM,b,err,lambda,OPTIONS_RiALM,m,n,q,A,A1,A2,Imat2q);
